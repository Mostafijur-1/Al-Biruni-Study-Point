...
export const STUDENT_EVENT_NAMES = [
  ...
  "student_game_hub_viewed",
  "student_quest_claimed",
  "student_reward_equipped",
  "student_community_viewed",
  "student_peer_encouraged",
  ...
  "student_goal_board_viewed",
  "student_weekly_goal_created",
  "student_weekly_goal_claimed",
  "student_science_lab_viewed",
  "student_science_lab_opened",
  "student_science_lab_completed",
  "student_formula_sprint_viewed",
  "student_formula_sprint_started",
  "student_formula_sprint_completed",
  "student_study_coach_viewed",
  "student_coach_recommendation_created",
  "student_coach_recommendation_launched",
] as const;
